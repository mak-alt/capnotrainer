...
const EditCleint = ({props, navigation}) => {
    ...
    ActionSheetIOS.showActionSheetWithOptions(
      ...
      buttonIndex => {
        if (buttonIndex === 0) {
          ...
          setResultClient('Rose');
        } else if (buttonIndex === 2) {
          setResultClient('Michael');
        } else if (buttonIndex === 3) {
          setResultClient('Jordan');
        }
      },
    );
        ...
        <ScrollView showsHorizontalScrollIndicator={false}>
          <View
              ...
              <View
                ...
                <View
                  ...
                  <Picker
                    ...
                    //   fontSize: 17,
                    // }}
                    selectedValue={resultClient}
                    onValueChange={(itemValue, itemIndex) => {
                      setResultClient(itemValue);
                    }}
            ...
            <View style={{width: '90%', marginLeft: '5%', marginTop: 20}}>
              <Text style={styles.txtStl}>Select Client Type</Text>
              <View style={{flexDirection: 'row', marginTop: 10}}>
                <TouchableOpacity
                  ...
                  onPress={() => setClientType(true)}>
                  <Fontisto
                    name={clientType ? 'radio-btn-active' : 'radio-btn-passive'}
                    size={20}
                    style={{marginRight: 10, marginTop: -2}}
                    color={clientType ? 'purple' : 'gray'}
                  />
                  <Text style={styles.txtStl}>List Active Clients Only</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => setClientType(false)}
                  style={{
                    width: '50%',
                    flexDirection: 'row',
                    justifyContent: 'flex-start',
                  ...
                  <Fontisto
                    name={clientType ? 'radio-btn-passive' : 'radio-btn-active'}
                    size={20}
                    style={{marginHorizontal: 10, marginTop: -2}}
                    color={clientType ? 'gray' : 'purple'}
                  />
                  <Text style={styles.txtStl}>List All Clients</Text>
                </TouchableOpacity>
              </View>
            </View>
            ...
            />
            <View style={{width: '90%', marginLeft: '5%', marginTop: 20}}>
              <Text style={styles.txtStl}>Deactivate Clients</Text>
              <View style={{flexDirection: 'row', marginTop: 10}}>
                <TouchableOpacity
                  style={{
                    width: '50%',
                  ...
                  onPress={() => setClientActive(true)}>
                  <Fontisto
                    name={
                      clientActive ? 'radio-btn-active' : 'radio-btn-passive'
                    }
                    size={20}
                    style={{marginRight: 10, marginTop: -2}}
                    color={clientActive ? 'purple' : 'gray'}
                  />
                  <Text style={styles.txtStl}>Yes</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => setClientActive(false)}
                  style={{
                    width: '50%',
                    flexDirection: 'row',
                    justifyContent: 'flex-start',
                  ...
                  <Fontisto
                    name={
                      clientActive ? 'radio-btn-passive' : 'radio-btn-active'
                    }
                    size={20}
                    style={{marginHorizontal: 10, marginTop: -2}}
                    color={clientActive ? 'gray' : 'purple'}
                  />
            ...
            <TouchableOpacity
              ...
              <Text style={{color: 'white'}}>Edit Client Profile</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>
